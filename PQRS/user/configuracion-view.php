        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta SoporteSystem</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de SoporteSystem</p>
            </div>
          </div><!--Fin row well-->
