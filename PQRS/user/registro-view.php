<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en SoporteSystem";
        $cabecera="From: SoporteSystem Colombia<sluque@qdit.co>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en SoporteSystem Colombia. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://www.linuxstore.com/index.php";
